    ...
    <section id="section-spencer">
        ...
        <div class="container p-0">
            <div class="text-center p-3" id="menu-list">
                <h1 class="text-red text-uppercase">Kazarelli's On The River Menu</h1>
                ...
                <div class="menu-item-underline"></div>
                @foreach($spencermenus->where('course', 'Salads') as $spencermenu)
                    <p><strong>{{ $spencermenu->item }}</strong><br>{{ $spencermenu->description }}</p>
                    @can('update', $spencermenu)
                        <div class="dropdown pb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="menu-item-underline"></div>
                @foreach($spencermenus->where('course', 'Sandwiches') as $spencermenu)
                    <p><strong>{{ $spencermenu->item }}</strong><br>{{ $spencermenu->description }}</p>
                    @can('update', $spencermenu)
                        <div class="dropdown pb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @foreach($spencermenus->where('course', 'Entrees') as $spencermenu)
                    <p><strong>{{ $spencermenu->item }}</strong><br>{{ $spencermenu->description }}</p>
                    @can('update', $spencermenu)
                        <div class="dropdown pb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="menu-item-underline"></div>
                @foreach($spencermenus->where('course', 'Beverages') as $spencermenu)
                    <p><strong>{{ $spencermenu->item }}</strong><br>{{ $spencermenu->description }}</p>
                    @can('update', $spencermenu)
                        <div class="dropdown pb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @foreach($spencermenus->where('course', 'Kid\'s Menu') as $spencermenu)
                    <p><strong>{{ $spencermenu->item }}</strong><br>{{ $spencermenu->description }}</p>
                    @can('update', $spencermenu)
                        <div class="dropdown pb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
